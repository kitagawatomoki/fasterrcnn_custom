...
from detection.misc import Conv2dNormActivation, SqueezeExcitation as SElayer
from detection._presets import ImageClassification
from detection.utils import _log_api_usage_once
from detection._api import register_model, Weights, WeightsEnum
from detection._meta import _IMAGENET_CATEGORIES
from detection._utils import _make_divisible, _ovewrite_named_param, handle_legacy_interface
